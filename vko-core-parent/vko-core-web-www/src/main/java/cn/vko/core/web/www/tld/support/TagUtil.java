...
public class TagUtil {
	public static void appendAttr(final StringBuilder content,
			final String prop, final Object value) {
	...
	public static void appendAttrWithEx(final StringBuilder content,
