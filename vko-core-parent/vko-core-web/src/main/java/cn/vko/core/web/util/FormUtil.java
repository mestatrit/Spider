...
public class FormUtil {
	 ...
	 * @return 该新增的实体对象
	 */
	public static <T> T add(final IDbDao dbDao, final IAddForm addForm,
			final Class<T> clazz) {
	 ...
	 * @return 更新的条数
	 */
	public static <T> int modify(final IDbDao dbDao, final IModForm modForm,
			final Class<T> clazz) {
		checkNull(dbDao, "数据库链接不能为空!");
	 ...
	 * @return 成功删除的个数
	 */
	public static <T> int delete(final IDbDao dbDao, final Class<T> clazz,
			final long... ids) {
	 ...
	 * @return map对象
	 */
	public static <T> Map<String, Object> query(final IDbDao dbDao,
			final Class<T> clazz, final Condition cnd, final Pager pager) {
		checkNull(dbDao, "dbDao对象不能为空");
	 ...
	 */
	public static <T> Map<String, Object> query(final IDbDao dbDao,
			final Class<T> clazz, final IQueryForm queryForm, final Pager pager) {
		checkNull(queryForm, "queryForm不能为空");
		Map<String, Object> map = query(dbDao, clazz, queryForm.createCnd(),
				pager);
	 ...
	 * @return map对象
	 */
	public static Map<String, Object> query(final IDbDao dbDao,
			final Sql pagerSql, final Sql countSql, final Pager pager) {
		checkNull(dbDao, "dbDao对象不能为空");
	 ...
	 */
	public static Map<String, Object> query(final IDbDao dbDao,
			final String pagerSqlStr, final String countSqlStr,
			final Pager pager) {
		return query(dbDao, Sqls.create(pagerSqlStr), Sqls.create(countSqlStr),
				pager);
	}
	 ...
	 */
	public static Map<String, Object> query(final IDbDao dbDao,
			final ISqlForm sqlForm, final Pager pager) {
		checkNull(sqlForm, "sqlForm不能为空");
		Map<String, Object> map = query(dbDao, sqlForm.createPagerSql(dbDao),
				sqlForm.createCountSql(dbDao), pager);
	 ...
	 * @return 节点和顺序号的map
	 */
	public static <T extends ITreeEntity> Map<String, Object> fetchParent(
			final DbDao dbDao, final Class<T> clazz, final long id) {
		checkNull(dbDao, "dbDao对象不能为空");
