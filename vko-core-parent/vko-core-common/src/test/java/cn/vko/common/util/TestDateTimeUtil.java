...
public class TestDateTimeUtil {
	...
	public void testDayOfThisMonth() {
		...
		Assert.assertEquals(
				"2013-02-01",
				DateTimeUtil.firstDayOfThisMonth(dateTime).toString(
						"yyyy-MM-dd"));
		Assert.assertEquals("2013-02-28",
				DateTimeUtil.lastDayOfThisMonth(dateTime)
						.toString("yyyy-MM-dd"));
		...
		Assert.assertEquals(
				...
				DateTimeUtil.firstDayOfThisMonth(dateTime).toString(
						"yyyy-MM-dd"));
		Assert.assertEquals("2012-04-30",
				DateTimeUtil.lastDayOfThisMonth(dateTime)
						.toString("yyyy-MM-dd"));
		...
		Assert.assertEquals(
				...
				DateTimeUtil.firstDayOfThisMonth(dateTime).toString(
						"yyyy-MM-dd"));
		Assert.assertEquals("2011-07-31",
				DateTimeUtil.lastDayOfThisMonth(dateTime)
						.toString("yyyy-MM-dd"));
	}
	...
	public void testDayOfThisWeek() {
		...
		Assert.assertEquals("2013-12-30",
				DateTimeUtil.firstDayOfThisWeek(dateTime)
						.toString("yyyy-MM-dd"));
		Assert.assertEquals("2014-01-05",
				DateTimeUtil.lastDayOfThisWeek(dateTime).toString("yyyy-MM-dd"));
		dateTime = new DateTime(2013, 12, 27, 23, 56, 14, 666);
		Assert.assertEquals("2013-12-23",
				DateTimeUtil.firstDayOfThisWeek(dateTime)
						.toString("yyyy-MM-dd"));
		Assert.assertEquals("2013-12-29",
				DateTimeUtil.lastDayOfThisWeek(dateTime).toString("yyyy-MM-dd"));
		dateTime = new DateTime(2014, 1, 31, 23, 56, 14, 666);
		Assert.assertEquals("2014-01-27",
				DateTimeUtil.firstDayOfThisWeek(dateTime)
						.toString("yyyy-MM-dd"));
		Assert.assertEquals("2014-02-02",
				DateTimeUtil.lastDayOfThisWeek(dateTime).toString("yyyy-MM-dd"));
	}

	@Test
	public void testDaysOfTwoTime() throws Exception {
		DateTime firstTime = DateTimeUtil.string2DateTime("2013-11-15",
				"yyyy-MM-dd");
		DateTime secondTime = DateTimeUtil.string2DateTime("2013-11-16",
				"yyyy-MM-dd");
		Assert.assertEquals(1,
				DateTimeUtil.daysOfTwoTime(firstTime, secondTime));
		DateTime firstTime1 = DateTimeUtil.string2DateTime("2013-10-10",
				"yyyy-MM-dd");
		DateTime secondTime1 = DateTimeUtil.string2DateTime("2013-11-16",
				"yyyy-MM-dd");
		Assert.assertEquals(37,
				DateTimeUtil.daysOfTwoTime(firstTime1, secondTime1));
		DateTime firstTime2 = DateTimeUtil.string2DateTime("2012-10-10",
				"yyyy-MM-dd");
		DateTime secondTime2 = DateTimeUtil.string2DateTime("2013-11-16",
				"yyyy-MM-dd");
		Assert.assertEquals(402,
				DateTimeUtil.daysOfTwoTime(firstTime2, secondTime2));
	}
