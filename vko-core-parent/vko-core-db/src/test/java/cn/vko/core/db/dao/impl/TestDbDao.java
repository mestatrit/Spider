...
public class TestDbDao {
	...
	public void testInsertWithOutAutoHasId() {
		...
		MockEntityWithoutId insertEntityWithoutId = dbDao
	...
	public void testInsertArray() {
		MockEntityWithAutoId[] autoEntities = {
				new MockEntityWithAutoId("测试1"),
				new MockEntityWithAutoId("测试2") };
	...
	public void testInsertArrayNotSame() {
		Object[] autoEntities = { new MockEntityWithAutoId("测试1"),
				new MockEntityWithoutAutoId("测试2") };
	...
	public void testInsertList() {
		Collection<MockEntityWithAutoId> autoEntities = list(
				new MockEntityWithAutoId("测试1"),
				new MockEntityWithAutoId("测试2"));
	...
	public void testInsertArrayHasNull() {
		MockEntityWithAutoId[] autoEntities = {
				new MockEntityWithAutoId("测试1"),
				new MockEntityWithAutoId("测试2"), null };
		dbDao.insert(autoEntities);
	}
	...
	public void testUpdateSingleAll() {
		...
		dbDao.update(entity);
		MockEntityWithAutoId updateEntity = dbDao.fetch(
				MockEntityWithAutoId.class, entity.getId());
	...
	public void testUpdateArrayParty() {
		...
		MockEntityWithAutoId[] entities = new MockEntityWithAutoId[] { entity1,
				entity2 };
		...
		MockEntityWithAutoId updateEntity1 = dbDao.fetch(
				MockEntityWithAutoId.class, entity1.getId());
		assertEquals(updateName, updateEntity1.getName());
		assertEquals(orginalAge1, updateEntity1.getAge());

		MockEntityWithAutoId updateEntity2 = dbDao.fetch(
				MockEntityWithAutoId.class, entity2.getId());
	...
	public void testFetchByCndNotHasId() {
		int notExistsId = -1;
		MockEntityWithoutId entity = dbDao.fetch(MockEntityWithoutId.class,
				Cnd.where("id", "=", notExistsId));
		assertNull(entity);
	}
	...
	public void testFetchByClassById() {
		...
		dbDao.insert(entity);
		MockEntityWithoutAutoId fetchEntity = dbDao.fetch(
				MockEntityWithoutAutoId.class, entity.getId());
	...
	public void testFetchByClassByNotExistsId() {
		int notExistsId = -1;
		MockEntityWithoutAutoId fetchEntity = dbDao.fetch(
				MockEntityWithoutAutoId.class, notExistsId);
	...
	public void testFetchByTableNameById() {
		MockEntityWithoutAutoId entity = new MockEntityWithoutAutoId("测试");
		dbDao.insert(entity);
		Record fetchEntity = dbDao.fetch("mock_entity_without_auto_id",
				entity.getId());
		assertNotNull(fetchEntity);
	...
	public void testFetchBySql() {
		...
		dbDao.insert(entity);
		Sql sql = Sqls
				.create("select * from mock_entity_without_auto_id $condition");
	...
	public void testDeleteNormal() {
		...
		MockEntityWithAutoId fetchEntity = dbDao.fetch(
				MockEntityWithAutoId.class, entity.getId());
		assertNull(fetchEntity);
	}
	...
	public void testDeleteByIdNormal() {
		MockEntityWithAutoId entity = new MockEntityWithAutoId("测试");
		dbDao.insert(entity);
		assertEquals(dbDao.delete(MockEntityWithAutoId.class, entity.getId()),
				1);
		MockEntityWithAutoId fetchEntity = dbDao.fetch(
				MockEntityWithAutoId.class, entity.getId());
		assertNull(fetchEntity);
	...
	public void testQueryByClass() {
		int pageSize = 21;
		List<?> list = dbDao.query(MockEntity4DbQuery.class, null,
				new Pager().setPageSize(pageSize));
	...
	public void testQueryByTableName() {
		int pageSize = 21;
		List<?> list = dbDao.query("mock_entity_4_query", null,
				new Pager().setPageSize(pageSize));
		assertEquals(pageSize, list.size());
	}
	...
	public void testQueryByClassCnd() {
		int id = 12;
		List<?> list = dbDao.query(MockEntity4DbQuery.class,
				Cnd.where("id", "<=", id), null);
	...
	public void testQueryByTableNameCnd() {
		int id = 12;
		List<?> list = dbDao.query("mock_entity_4_query",
				Cnd.where("id", "<=", id), null);
		assertEquals(id, list.size());
	}
	...
	public void testQueryBySql() {
		int pageSize = 21;
		Sql sql = Sqls.create(" select * from mock_entity_4_query");
		List<Record> list = dbDao.query(sql, null,
				new Pager().setPageSize(pageSize));
		assertEquals(pageSize, list.size());
	}
