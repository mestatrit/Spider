...
/**
 * 抽象的cms父类 主要提供统一的匹配类别的逻辑，比如将<cms:date uid="2013-12-31 12:30:00">
...
public abstract class AbstractCms implements ICms {
	...
	@Override
	public void change(final HttpServletRequest req, final Set<String> cmsTags,
	 ...
	 * @return 转换为map
	 */
	protected abstract void changeMatch(final HttpServletRequest req,
