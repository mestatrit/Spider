package cn.xuexibao.business.spider.model.yitiku;
...
@HelpUrl(value = { "http://www.yitiku.cn/tiku/huaxue/",
		"http://www.yitiku.cn/tiku/huaxue/[0-9]*" })
@TargetUrl("http://www.yitiku.cn/shiti/*")
@Data
public class YiTiKuChemical implements IExam {
