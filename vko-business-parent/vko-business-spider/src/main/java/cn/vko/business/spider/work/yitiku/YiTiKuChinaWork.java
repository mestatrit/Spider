...
public class YiTiKuChinaWork extends YiTiKuWork {

	public YiTiKuChinaWork(FilterScheduler scheduler,
			IMysqlPipeline<?> pipeline, boolean useProxy) {
		super("yw.yitiku.cn", "yitiku.cn", scheduler, pipeline, useProxy);
	}

	@Override
	@SuppressWarnings("rawtypes")
	protected void addUrl(OOSpider spider) {
		spider.addUrl("http://www.yitiku.cn/tiku/yuwen");
	}
	...
	protected CookieStore getCookie(HttpHost proxy) {
		...
		map.put("account", "newlifeday@126.com");
		map.put("password", "890098ytk");
		try {
