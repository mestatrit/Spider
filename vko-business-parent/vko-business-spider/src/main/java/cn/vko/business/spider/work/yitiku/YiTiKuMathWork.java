...
import cn.vko.business.spider.model.yitiku.YiTiKuMath;
...
public class YiTiKuMathWork extends YiTiKuWork {

	public YiTiKuMathWork(FilterScheduler scheduler,
			IMysqlPipeline<?> pipeline, boolean useProxy) {
		super("sx.yitiku.cn", "yitiku.cn", scheduler, pipeline, useProxy);
	}

	@Override
	@SuppressWarnings("rawtypes")
	protected void addUrl(OOSpider spider) {
		spider.addUrl("http://www.yitiku.cn/tiku/shuxue");
	}
