...
import cn.vko.business.spider.model.yitiku.YiTiKuChemical;
...
public class YiTiKuChemicalWork extends YiTiKuWork {

	public YiTiKuChemicalWork(FilterScheduler scheduler,
			IMysqlPipeline<?> pipeline, boolean useProxy) {
		super("ch.yitiku.cn", "yitiku.cn", scheduler, pipeline, useProxy);
	}

	@Override
	@SuppressWarnings("rawtypes")
	protected void addUrl(OOSpider spider) {
		spider.addUrl("http://www.yitiku.cn/tiku/huaxue");
	}
