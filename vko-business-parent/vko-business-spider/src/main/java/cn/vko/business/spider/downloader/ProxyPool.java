...
public class ProxyPool {
	...
	// "http://api.iphai.com/getapi.ashx?ddh=575508240831742&yys=1&am=0&guolv=y&mt=6&fm=text&num=";
	private final static String FETCH_URL = "http://www.56pu.com/api?orderId=613603760511213&line=all&region=&regionEx=&beginWith=&ports=&vport=&speed=&anonymity=&scheme=&duplicate=3&quantity=";
