...
import cn.vko.business.spider.model.yitiku.YiTiKuPhysical;
...
public class YiTiKuPhysicalWork extends YiTiKuWork {

	public YiTiKuPhysicalWork(FilterScheduler scheduler,
			IMysqlPipeline<?> pipeline, boolean useProxy) {
		super("ph.yitiku.cn", "yitiku.cn", scheduler, pipeline, useProxy);
	}

	@Override
	@SuppressWarnings("rawtypes")
	protected void addUrl(OOSpider spider) {
		spider.addUrl("http://www.yitiku.cn/tiku/wuli");
	}
	...
	protected OOSpider createSpider(CookieStore cookieStore) throws Exception {
		...
		OOSpider spider = BlockOOSpider
				.create(site
						...
						getPipeline(), YiTiKuPhysical.class);
	...
	protected CookieStore getCookie(HttpHost proxy) {
		...
		map.put("account", "819599114@qq.com");
